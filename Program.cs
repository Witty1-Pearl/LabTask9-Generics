...
namespace IntergenicResearchLibray
{
    class Program
    {
        static void Main(string[] args)
        {
                ...
                Library library1 = new Library(30, 6, 2020, 2, 6, 2020, "Phibie", "100 level", "The Hard Way", "QW345", "Ahmed","Pride of Barbados", "Pl345");
                Library library2 = new Library(4, 8, 2020, 7, 8, 2020, "Faruk", "200 level", "Why we struck", "DF478", "Blessing","Say Hello", "GT657");
                Library library3 = new Library(24, 4, 2020, 2, 4, 2020, "Mohammed", "300 level", "Medicine in the", "CCR345", "Wella","Metallurgy", "DS358");
            ...
            GenericDefaulterList<IDefaulterList> library = new GenericDefaulterList<IDefaulterList>(6); 
